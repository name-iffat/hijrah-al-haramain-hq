    ...
    <div className="pt-32 pb-24 min-h-screen bg-sand-50 font-sans relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-serif text-olive-900 mb-4">Contact Us for Your Spiritual Journey</h1>
          <p className="text-olive-600 text-lg font-light">
            We are here to assist you with your Umrah, Hajj, and Halal travel plans.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-start">
          ...
          <div className="w-full lg:w-7/12 relative">
            <div className="bg-white rounded-[2rem] shadow-xl p-8 md:p-12 relative overflow-hidden border border-sand-200">
              ...
              <h2 className="text-3xl font-serif text-gold-500 mb-8 relative z-10">Inquiry Form</h2>
              ...
              {isSubmitted ? (
                <div className="bg-mint-100 border border-mint-200 text-olive-800 p-8 rounded-2xl flex flex-col items-center justify-center text-center min-h-[400px]">
                  ...
                  <p className="font-serif font-bold text-2xl mb-2">Inquiry Received</p>
                  <p className="opacity-80">Jazakallah Khair. We will contact you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="name" className="block text-sm font-bold text-olive-900">Full Name</label>
                      <input
                    ...
                    {/* Email Address */}
                    <div className="space-y-2">
                      <label htmlFor="email" className="block text-sm font-bold text-olive-900">Email Address</label>
                      <input
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Phone Number */}
                    <div className="space-y-2">
                      <label htmlFor="phone" className="block text-sm font-bold text-gray-500">Phone Number <span className="font-normal text-xs">(optional)</span></label>
                      <input
                    ...
                    {/* Inquiry Type */}
                    <div className="space-y-2">
                      <label htmlFor="inquiryType" className="block text-sm font-bold text-olive-900">Inquiry Type</label>
                  ...
                  {/* Message */}
                  <div className="space-y-2">
                    <label htmlFor="message" className="block text-sm font-bold text-olive-900">Message / Special Requests</label>
                    <textarea
                      ...
                      placeholder="Tell us more about your pilgrimage plans..."
                    ></textarea>
                  </div>
          ...
          <div className="w-full lg:w-4/12 relative">
            <div className="bg-white rounded-[2rem] shadow-xl p-8 relative overflow-hidden h-full flex flex-col border border-sand-200">
              ...
              <h2 className="text-3xl font-serif text-gold-500 mb-8 relative z-10">Get in Touch</h2>
              ...
              <div className="space-y-6 relative z-10 mb-8">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-olive-900 font-medium">+1 (800) 123-4567</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-olive-900 font-medium">+1 (555) 987-6543</span>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <span className="text-olive-900 font-medium leading-tight">123 Noor Street, Makkah Al-Mukarramah, Saudi Arabia</span>
                </div>
              </div>
